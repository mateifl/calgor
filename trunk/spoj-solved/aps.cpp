...
int main(int argc, char** argv) {
	...
	// cout << "Sum: " << accumulate(numbers.begin(), numbers.end(), sum) << endl;
	// sum = 1000000;
	// cout << "Sum: " << accumulate(numbers.begin(), numbers.begin() + (sum / 2), sum) << endl;
	// sum = 9999999;
	// cout << "Sum: " << accumulate(numbers.begin(), numbers.begin() + ((sum + 1)/2), sum) - 1 << endl;
	// sum = 9999998;
	// cout << "Sum: " << accumulate(numbers.begin(), numbers.begin() + (sum/2), sum) << endl;
	// sum = 5999997;
	// cout << "Sum: " << accumulate(numbers.begin(), numbers.begin() + ((sum + 1)/2), sum) - 1 << endl;
